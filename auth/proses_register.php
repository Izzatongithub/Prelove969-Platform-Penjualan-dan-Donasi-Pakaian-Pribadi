...
if(mysqli_num_rows($cek) > 0){
    echo "<script>alert('Username atau email sudah terdaftar!'); window.location='../index.php?error=exists';</script>";
    exit;
}
...
if($query){
    ...
    echo "<script>alert('Registrasi gagal!'); window.location='../index.php?error=gagal';</script>";
}
?>