...
<body>
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="../admin_fix/admin.php" class="btn btn-secondary">Kembali ke Dashboard</a>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <form class="d-flex">
                    ...
                    <input type="text" name="search" class="form-control me-2" placeholder="Cari donatur..." value="<?= htmlspecialchars($search) ?>">
